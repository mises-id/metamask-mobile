...
export default (env) => {
  const {
    mode = 'development',
    context = getDirname(import.meta.url),
    entry = './index.js',
  ...
  return {
    ...
    output: {
      ...
      publicPath: getPublicPath({ platform, devServer }),
    },
    /**
    ...
    plugins: [
      ...
      new plugins.ModuleFederationPlugin({
        name: 'metamask',
        exposes: {
          './App': './app/components/Nav/Main/MainNavigator',
        },
        shared: deps,
      }),
    ],
